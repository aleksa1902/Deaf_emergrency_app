...
class FireActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendInfoButton.setOnClickListener {
            val data = FireData(
                fireLocationEditText.text.toString(),
                fireWhatEditText.text.toString(),
    ...
    private fun getCurrentLocationAndSendData(data: FireData, net: Boolean) {
                ...
                object : LocationListener {
                    override fun onLocationChanged(location: Location) {
                        if(net){
                            ...
                            FirebaseHelper.saveData(data, "fire", this@FireActivity)
                        }else{
