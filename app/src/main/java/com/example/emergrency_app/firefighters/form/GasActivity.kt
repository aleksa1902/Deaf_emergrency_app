...
import com.example.emergrency_app.firefighters.data.GasData
...
class GasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendInfoButton.setOnClickListener {
            val data = GasData(
                odorEditText.text.toString(),
                gasLocationEditText.text.toString(),
    ...
    private fun getCurrentLocationAndSendData(data: GasData, net: Boolean) {
                ...
                object : LocationListener {
                    override fun onLocationChanged(location: Location) {
                        if(net){
                            ...
                            FirebaseHelper.saveData(data, "gas", this@GasActivity)
                        }else{
