    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendInfoButton.setOnClickListener {
            ...
            val data = mapOf(
                ...
                "Gde se nalazi izvor problema (kuća, zgrada, ulica itd.)?" to gasLocationEditText.text.toString(),
                "Jesu li ljudi u blizini izvora curenja?" to stuckEditText.text.toString(),
                "Je li plin izložio riziku okolne objekte ili područja?" to dangerEditText.text.toString(),
                "Imate li informacije o vrsti plina koji curi?" to additionalInfoEditText.text.toString()
            )

            val firefighterData = FirefighterData()
            firefighterData.userId = userId.toString()
            firefighterData.type = "gas"
