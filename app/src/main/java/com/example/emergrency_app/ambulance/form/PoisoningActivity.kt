...
import com.example.emergrency_app.ambulance.data.PoisoningData
...
class PoisoningActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendInfoButton.setOnClickListener {
            val data = PoisoningData(
                poisoningThingEditText.text.toString(),
                poisoningWhenEditText.text.toString(),
                feelingEditText.text.toString(),
    ...
    private fun getCurrentLocationAndSendData(data: PoisoningData, net: Boolean) {
                ...
                object : LocationListener {
                    override fun onLocationChanged(location: Location) {
                        if(net){
                            ...
                            FirebaseHelper.saveData(data, "poisoning", this@PoisoningActivity)
                        }else{
